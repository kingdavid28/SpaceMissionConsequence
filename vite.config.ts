  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          name: 'Mission Consequence Engine',
          short_name: 'MCE',
          description: 'AI co-pilot for real-time astronaut decision support, threat detection, and offline guidance.',
          theme_color: '#060a10',
...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? "Mission Consequence Engine"
